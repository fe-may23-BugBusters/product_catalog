...
export const About: React.FC = () => {
  return (
    <div className="about">
      ...
      <h3 className="about_h3 line-separator">
      ...
      <p className="about_p">
        ...
        creative control, too, with four times more scene and powerful
